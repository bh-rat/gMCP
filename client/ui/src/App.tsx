        ...
        <div style={{ marginBottom: '30px', padding: '20px', border: '1px solid #ffa500', borderRadius: '6px', background: '#fff8dc' }}>
          ...
          <div style={{ background: '#f0f8ff', padding: '15px', borderRadius: '4px', margin: '10px 0', borderLeft: '4px solid #0066cc' }}>
            ...
            <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
              <li><strong>Required field:</strong> {`{"location": ""}`} → Server returns "field 'location' is required"</li>
              <li><strong>Type validation:</strong> {`{"location": "NYC", "latitude": "abc"}`} → Server returns type error</li>
              <li><strong>Valid data:</strong> {`{"location": "NYC"}`} → Successful call</li>
            </ul>
            <p><em>🔄 All validation happens on gRPC server</em></p>
          </div>
