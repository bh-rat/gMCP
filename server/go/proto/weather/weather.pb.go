...
const file_weather_weather_proto_rawDesc = "" +
	"\n" +
	"\x15weather/weather.proto\x12\x10examples.weather\x1a\x17validate/validate.proto\"g\n" +
	"\x11GetWeatherRequest\x12#\n" +
	"\blocation\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\blocation\x12-\n" +
	"\x05units\x18\x02 \x01(\tB\x17\xfaB\x14r\x12R\x06metricR\bimperialR\x05units\"u\n" +
	"\x12GetWeatherResponse\x12#\n" +
	"\rtemperature_c\x18\x01 \x01(\x01R\ftemperatureC\x12\x1e\n" +
	"\n" +
	"conditions\x18\x02 \x01(\tR\n" +
	"conditions\x12\x1a\n" +
	"\bhumidity\x18\x03 \x01(\rR\bhumidity\"\x8c\x01\n" +
	"\x19GetWeatherForecastRequest\x12#\n" +
	"\blocation\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\blocation\x12\x1b\n" +
	"\x04date\x18\x02 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04date\x12-\n" +
	"\x05units\x18\x03 \x01(\tB\x17\xfaB\x14r\x12R\x06metricR\bimperialR\x05units\"\xad\x01\n" +
